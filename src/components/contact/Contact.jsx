        ...
        <div className="container contact__container">
          <div className="contact__options">
            <article className="contact__option">
              ...
              <a href="mailto:khintibidzel@gmail.com" target="_blank" rel="noreferrer">Send me an Email</a>
            </article>
            <article className="contact__option">
              <RiMessengerLine size="25px"/>
              <h4>Messenger</h4>
              <h5>Luka Khintibidze</h5>
              <a href="https://m.me/lkhintibidze" target="_blank" rel="noreferrer">Send me a message</a>
            </article>
            <article className="contact__option">
