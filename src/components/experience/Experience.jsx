      ...
      <div className="container experience__container">
        <div className="education">
          <div className="education__content">
            ...
            <br />
            <article className='experience__details'>
              <h4>I also have number of tech related certificates that you can view on my <a href="https://www.linkedin.com/in/khintibidzel/details/certifications/">LinkedIn Profile</a> </h4>
            </article>
          </div>
        </div>
